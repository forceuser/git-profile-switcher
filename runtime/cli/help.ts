...
export const COMMANDS: CommandHelp[] = [
  ...
  },
  {
    ...
    usage: "gip bind [profile] [directory] [--global|-g]",
    completionFlags: ["--global", "-g", "--help"],
    examples: [
      "gip bind",
      "gip bind work",
      "gip bind personal ~/Developer/personal-app",
      "gip bind work --global",
      "gip bind -g",
    ],
  },
  {
    ...
    usage: "gip use [profile] [--clear] [--exports] [--shell <zsh|bash|fish>]",
    completionFlags: ["--clear", "--exports", "--shell", "--help"],
    examples: [
      "gip use work",
      "gip use --clear",
      'eval "$(gip use work --exports)"',
      "gip use work --exports --shell fish",
    ],
  },
  {
    name: "clear",
  ...
  {
    name: "version",
    summary: "Print the installed gip version.",
    usage: "gip version\n  gip --version",
    completionFlags: ["--help"],
    examples: ["gip version", "gip --version"],
  },
  {
    name: "tui",
